...
python ${REPO_PATH}/examples/agent/rstar2/main_rstar2.py --config-path ${CONFIG_PATH}/config/  --config-name $CONFIG_NAME "runner.logger.logger_backends=${LOGGER_BACKENDS}"
