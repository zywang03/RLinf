...
python ${REPO_PATH}/examples/agent/coding_online_rl/main_coding_rl_llm_judge.py --config-path ${CONFIG_PATH}/config/  --config-name $CONFIG_NAME "runner.logger.logger_backends=${LOGGER_BACKENDS}"
